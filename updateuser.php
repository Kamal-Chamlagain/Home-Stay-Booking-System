...
?>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                <form action="userprocess.php" method="POST" enctype="multipart/form-data" id="updatecustomer">
                <?php
...
while ($row2 = mysqli_fetch_assoc($query)) {
    ...
    <p id="error3" style="color:red;"></p>
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="cname" name="uname" placeholder="Username" value="<?php echo $row2['username']?>"required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="Email" id="cemail" name="uemail" placeholder="Email" value="<?php echo $row2['email']?>"required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <input type="text" id="caddress" name="uaddress" placeholder="Address" value="<?php echo $row2['uaddress']?>"required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <input type="number" id="cphone" name="uphone" placeholder="Phone NUmber" value="<?php echo $row2['uphone']?>" min="0"required>
                        </div>
                    </div>
        ...
        <script derfer src="script2.js"></script>
